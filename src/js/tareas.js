(function(){
    ...
    function mostrarFormulario(editar = false, tarea = {}){ 
        ...
        <form class="formulario nueva-tarea">
            ...
            <div class="opciones">
                ...
                />
                <buttom type="button" class="cerrar-modal">Cancelar</buttom>
            </div>
        </form>
        `;
        ...
        modal.addEventListener('click', function(e){
            ...
            if(e.target.classList.contains('submit-nueva-tarea')){
                ...
                if(nombreTarea === ''){
                    ...
                    mostrarAlerta('El nombre de la tarea es Obligatrio', 'error',
    ...
    //consultar el servidor para añadir tarea al proyecto seleccionado
